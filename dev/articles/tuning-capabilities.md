...
```
    ...
    ##  1 <int [1]>      <chr [1]>     2.99e- 6 rmse    standard   4.32       5 0.0784 
    ##  2 <int [1]>      <chr [1]>     2.99e- 6 rsq     standard   0.310      5 0.179  
    ##  3 <int [2]>      <chr [2]>     9.46e- 5 rmse    standard   4.15       5 0.0660 
    ##  4 <int [2]>      <chr [2]>     9.46e- 5 rsq     standard   0.461      5 0.0751 
    ##  5 <int [1]>      <chr [1]>     4.09e- 4 rmse    standard   3.98       5 0.0146 
    ##  6 <int [1]>      <chr [1]>     4.09e- 4 rsq     standard   0.583      5 0.135  
    ##  7 <int [1]>      <chr [1]>     2.98e- 8 rmse    standard   4.41       5 0.123  
    ##  8 <int [1]>      <chr [1]>     2.98e- 8 rsq     standard   0.221      5 0.0894 
    ##  9 <int [1]>      <chr [1]>     3.66e- 2 rmse    standard   0.0815     5 0.0100 
    ## 10 <int [1]>      <chr [1]>     3.66e- 2 rsq     standard   0.990      5 0.00249
    ## 11 <int [3]>      <chr [3]>     1.62e- 7 rmse    standard   4.25       5 0.0469 
    ## 12 <int [3]>      <chr [3]>     1.62e- 7 rsq     standard   0.320      5 0.124  
    ## 13 <int [3]>      <chr [3]>     5.56e-10 rmse    standard   4.18       5 0.100  
    ## 14 <int [3]>      <chr [3]>     5.56e-10 rsq     standard   0.427      5 0.0962 
    ## 15 <int [1]>      <chr [1]>     1.06e- 9 rmse    standard   4.28       5 0.0975 
    ## 16 <int [1]>      <chr [1]>     1.06e- 9 rsq     standard   0.491      5 0.150  
    ## 17 <int [1]>      <chr [1]>     1.40e- 5 rmse    standard   4.34       5 0.0606 
    ## 18 <int [1]>      <chr [1]>     1.40e- 5 rsq     standard   0.316      5 0.0913 
    ## 19 <int [2]>      <chr [2]>     1.59e- 3 rmse    standard   0.703      5 0.0726 
    ## 20 <int [2]>      <chr [2]>     1.59e- 3 rsq     standard   0.569      5 0.138  
...
```
    ...
    ##   hidden_neurons activations learn_rate .metric .estimator   mean     n std_err
    ##   <list>         <list>           <dbl> <chr>   <chr>       <dbl> <int>   <dbl>
    ## 1 <int [1]>      <chr [1]>     3.66e- 2 rmse    standard   0.0815     5  0.0100
    ## 2 <int [2]>      <chr [2]>     1.59e- 3 rmse    standard   0.703      5  0.0726
    ## 3 <int [1]>      <chr [1]>     4.09e- 4 rmse    standard   3.98       5  0.0146
    ## 4 <int [2]>      <chr [2]>     9.46e- 5 rmse    standard   4.15       5  0.0660
    ## 5 <int [3]>      <chr [3]>     5.56e-10 rmse    standard   4.18       5  0.100 
    ## # ℹ 1 more variable: .config <chr>
